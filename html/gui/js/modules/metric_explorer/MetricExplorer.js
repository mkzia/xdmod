                ...
                menu.addItem({
                    ...
                    handler: function ( /*b*/) {
                        ...
                        if (dimension !== "none") {
                            ...
                            parameters.global_filters = encodeURIComponent(JSON.stringify({
                                data: filters
                            }));
                        }
...
Ext.extend(XDMoD.Module.MetricExplorer, XDMoD.PortalModule, {
    ...
    initComponent: function () {
        ...
        self.on('chart_link_clicked', function () {
            ...
            var msg = 'Use the following link to share the current chart. <br> We recommend using Chrome or Firefox if the link does not work in Internet Explorer.<br> <b>' + link + '</b>';
            Ext.Msg.show({
                title: 'Link to Chart',
                minWidth: 700,
                msg: msg,
